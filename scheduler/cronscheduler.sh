...
curl http://localhost:6800/schedule.json -d project=qrator -d spider=TechCrunch >> jobIDs.txt
curl http://localhost:6800/schedule.json -d project=qrator -d spider=DiscoverMag >> jobIDs.txt
